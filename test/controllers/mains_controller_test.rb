...
class MainsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create main" do
    assert_difference("Main.count") do
      post mains_url, params: { main: { car_plate: @main.car_plate, car_type: @main.car_type, check_in_time: @main.check_in_time, parking_slots: @main.parking_slots, phone_number: @main.phone_number } }
    end
  ...
  test "should update main" do
    patch main_url(@main), params: { main: { car_plate: @main.car_plate, car_type: @main.car_type, check_in_time: @main.check_in_time, parking_slots: @main.parking_slots, phone_number: @main.phone_number } }
